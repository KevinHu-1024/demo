(function () {
    ...
    function animate(curEle, tarObj, duration, effect) {
        ...
        if (typeof effect === "number") {
            ...
            for (var i = 0; i < ary.length; i++) {
                if (effect === (i + 1)) {
                    ...
                    fnEffect = curItem.length === 1 ? myEffect[curItemFir] : myEffect[curItemFir][curItemTwo];
                    break;
                }
            }
            ...
            fnEffect = effect.length === 1 ? myEffect[effectFir] : myEffect[effectFir][effectTwo];
        }
        ...
        myEvent.fire.call(curEle, "myAnimateStart");
        ...
        curEle.timer = window.setInterval(function () {
            ...
            if (times >= duration) {
                ...
                myEvent.fire.call(curEle, "myAnimateEnd");
                return;
            }
